...
export default function SetorFinanceiro() {
  ...
  const onSubmit = async (data: FormValues) => {
    console.log('Contato setor financeiro:', data)
        ...
        <div className="container max-w-2xl mx-auto relative z-10 text-center">
          <div className="bg-black/40 backdrop-blur-md border border-green-500/30 rounded-2xl p-12">
            ...
            <p className="text-white/90 text-lg mb-6">
              Sua mensagem foi enviada ao setor financeiro. Entraremos em contato em breve.
            </p>
      ...
      <div className="container max-w-2xl mx-auto relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-white/80">
            Entre em contato com nosso setor financeiro para questões sobre pagamentos, parcelamentos e valores
          </p>
        </div>
        ...
        >
          ...
          <FormField label="Assunto" error={errors.assunto} required>
            ...
            >
              ...
              <option value="pagamento" className="bg-gray-800">Pagamento</option>
              <option value="parcelamento" className="bg-gray-800">Parcelamento</option>
              <option value="valores" className="bg-gray-800">Valores e Preços</option>
              <option value="boleto" className="bg-gray-800">Segunda via de boleto</option>
