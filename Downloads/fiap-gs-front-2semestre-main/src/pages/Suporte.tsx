...
export default function Suporte() {
  ...
  const onSubmit = async (data: FormValues) => {
    // Simulação de envio - em produção, enviaria para API
    console.log('Dados do suporte:', data)
    ...
    <section className="py-20 px-4 relative overflow-hidden min-h-screen">
      ...
      <div className="container max-w-2xl mx-auto relative z-10">
        ...
        >
          ...
          <FormField label="Situação que deseja falar" error={errors.situacao} required>
            <textarea
              {...register('situacao', { required: 'Descreva a situação' })}
