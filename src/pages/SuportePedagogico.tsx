...
export default function SuportePedagogico() {
  const [submitted, setSubmitted] = useState(false)
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<FormValues>()

  const onSubmit = async (data: FormValues) => {
    console.log('Contato suporte pedagógico:', data)
        ...
        <div className="container max-w-2xl mx-auto relative z-10 text-center">
          <div className="bg-black/40 backdrop-blur-md border border-green-500/30 rounded-2xl p-12">
            ...
            <p className="text-white/90 text-lg mb-6">
              Sua mensagem foi enviada ao suporte pedagógico. Entraremos em contato em breve.
            </p>
      ...
      <div className="container max-w-2xl mx-auto relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-white/80">
            Entre em contato com nosso suporte pedagógico para questões sobre cursos, conteúdo e aprendizado
          </p>
        </div>
        ...
        >
          ...
          <FormField label="Assunto" error={errors.assunto} required>
            ...
            >
              ...
              <option value="duvida-conteudo" className="bg-gray-800">Dúvida sobre Conteúdo</option>
              <option value="acesso-curso" className="bg-gray-800">Acesso ao Curso</option>
              <option value="certificado" className="bg-gray-800">Certificado</option>
              <option value="material" className="bg-gray-800">Material de Estudo</option>
          ...
          <FormField label="Mensagem" error={errors.mensagem} required>
            <textarea
              ...
              placeholder="Descreva sua questão pedagógica..."
            />
          </FormField>
